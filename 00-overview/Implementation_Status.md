...
- **LLM provider** (`live_provider.py`): OpenRouter/Anthropic chat completions adapter plus Claude Code CLI adapter
...
- OpenRouter/Anthropic providers plus Claude Code CLI adapter
