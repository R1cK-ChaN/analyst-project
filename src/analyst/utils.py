"""Lightweight text and URL utility functions.

Extracted from ingestion.scrapers._common and ingestion.url_canon so that
storage and other non-ingestion modules can use them without pulling in the
full ingestion package.
"""
...
# ---------------------------------------------------------------------------
# Indicator name normalization (from scrapers._common)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# URL canonicalization (from ingestion.url_canon)
# ---------------------------------------------------------------------------
