...
- the Telegram bot is deployed to a Contabo VPS with group chat support (observe silently, reply on @mention), full tool access, time-of-day awareness, absence awareness, typing simulation between multi-bubble messages, static image generation via Volcengine Seedream with photo delivery, and optional motion-selfie/live-photo generation via Seedance with Telegram video delivery
...
- Telegram agent bot with persona (陈襄), group chat support, 13 autonomous tools, Seedream image generation with photo delivery, and Seedance motion-selfie delivery as Telegram video
