...
Implemented in `src/analyst/tools/`:
...
- agent tools: `web_search`, `get_regime_summary`, `get_calendar`, `get_premarket_briefing` — agent autonomously decides when to fetch data
